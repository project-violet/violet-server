...
CREATE TABLE `viewreport` (
	...
	`TimeStamp` TIMESTAMP NULL DEFAULT NULL,
	`StartsTime` TIMESTAMP NULL DEFAULT NULL,
	`EndsTime` TIMESTAMP NULL DEFAULT NULL,
	`ValidSeconds` INT(11) NULL DEFAULT NULL,
	`MsPerPages` MEDIUMTEXT NULL DEFAULT NULL COLLATE 'utf8_general_ci',
